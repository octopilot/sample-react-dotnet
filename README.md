...
**One repo: React frontend + ASP.NET Core API.**

| Part       | Stack        | Build     |
|------------|--------------|-----------|
| **frontend** | React (Vite) | Dockerfile |
| **api**      | ASP.NET Core 8 | buildpacks |
...
op build-push
docker run -p 8081:8080 sample-react-dotnet-api &
docker run -p 8080:8080 sample-react-dotnet-frontend
```
